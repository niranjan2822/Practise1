...
python = Snake()  # means this is the constructor create an object we need a call the constructor means call to the class by calling the class name
print(python)
...
python1 = Snake()  # object
python2 = Snake  # object
...
class Snake:
    def __init__(self, name):  # init constructor its a special function
        self.name = name
